...
public:
  ...
  // 破棄する
  virtual void reserve_clear(ISocketLike *socket,
                             t_observation_target from) = 0;
  ...
  virtual void reserve_transit(ISocketLike *socket, t_observation_target from,
                               t_observation_target to) = 0;
};
